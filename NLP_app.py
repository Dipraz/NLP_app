...
def main():
    ...
    if st.checkbox("Show Sentiment Analysis"):
        ...
        st.image("Sentiment-Analysis-Using-Python-i2tutorials.jpg", caption="Sentiment Analysis")
        message = st.text_area("Enter your text", "Type here", key="text_area_sentiment")
